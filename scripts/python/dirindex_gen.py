#!/usr/bin/env python3
# Forked from: https://gist.github.com/glowinthedark/625eb4caeca12c5aa52778a3b4b0adb4
# ---
...
""")
    ...
    for entry in sorted_entries:
        ...
        moddate = ""
        if not skipmod:
            moddate = f"""                    <td class="hideable"><time datetime="{last_modified_iso}">{last_modified_human_readable}</time></td>
            """
        data = f"""
        <tr class="file">
            <td></td>
...
if __name__ == "__main__":
    ...
    parser.add_argument('--skipmod', '-s',
                        action='store_true',
                        help="Skip adding the modification date of files (FALSE by default)",
                        required=False)
