...
def main():
    parser = argparse.ArgumentParser(description="Sharif Net2 login and print user info")
    ...
    # --- Session Initialization and Login ---
    ...
    try:
        ...
        connect_headers = {
            ...
            "Referer": LOGIN_URL, # Should point to a page inside the site after login
        }
