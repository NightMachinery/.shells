...
# Written by setup/bootstrap/stages/00-dirs.sh.
...
cat > "${env_file}" <<EOF
# -*- mode: sh; -*-
#: Generated by setup/bootstrap/stages/00-dirs.sh
#: Storage contract for this host. Edit NIGHT_BIG_STORE here (or in
#: setup/bootstrap/profiles/) to relocate the heavy trees.
#:
#: ############################################################################
...
#: Added by setup/bootstrap stage 00.
