...
gcloud beta quotas info describe PREEMPTIBLE-NVIDIA-H100-GPUS-per-project-region \
  --service=compute.googleapis.com --project=relation-neuron-detection --format=json
```
