...
##
# tx: Stands for "Transmit". In the context of this script, it's referring to the data being sent (transmitted) from the network interface.
#
# rx: Stands for "Receive". In the context of this script, it's referring to the data being received by the network interface.
##
# You can see the network interfaces with `ip addr show`.
##
