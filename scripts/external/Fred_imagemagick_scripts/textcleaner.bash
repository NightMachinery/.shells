#!/bin/bash
# 
# Developed by Fred Weinhaus 6/9/2009 .......... revised 7/12/2021
# 
# ------------------------------------------------------------------------------
# 
# Licensing:
...
# [-i invert] [-C compression] infile outfile
...
convert -respect-parenthesis \( $tmpA1 $rotation $cropping $makegray $enhancing \) \
	...
	$unrotating $sharpening $modulation $adaptiveblurring $trimming $padding $inversion2 $compressing \
	"$outfile"
