...
## uni
tmuxnewshenv="rt_skip='$rt_skip' rt_e=(tsend --link-preview -- $water) rt_notel=y rt_ge=(withchrome getlinks-uniq -e '/session/id/video/') rt_nt=y rt_eid=$((3600*6)) rt_eud=0" tmuxnewsh rss-ocwvids rss-tsend 'http://ocw.sharif.edu/course/id/224'
##
