...
aliasfn ci20 curl-ip -x 'socks5h://127.0.0.1:1020'
...
aliasfn ci2050 curl-ip -x 'http://127.0.0.1:2050'
aliasfn ci51 curl-ip -x 'socks5h://127.0.0.1:1051'
aliasfn ci2051 curl-ip -x 'http://127.0.0.1:2051'
...
aliasfn ci75 curl-ip -x 'socks5h://127.0.0.1:1075'
aliasfn ci2075 curl-ip -x 'http://127.0.0.1:2075'
...
aliasfn ci3095 curl-ip -x 'socks5h://127.0.0.1:3095'
