...
source-basic variables compatibility deps magicmacros cached conditions crossplatform args colors debug text-manipulation ssh malice history eval enhancers redirections functional macros redis
