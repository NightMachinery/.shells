...
re source-basic magicmacros cached conditions crossplatform args colors debug text-manipulation ssh malice eval enhancers redirections functional completions macros
